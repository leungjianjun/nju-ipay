...
public class GoodsArrayAdapter extends ArrayAdapter<Product> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView != null) {
			...
			holder.goodsName=(TextView)view.findViewById(R.id.goods_item_name);
			holder.goodsMeta=(TextView)view.findViewById(R.id.goods_item_meta);
			holder.delButton=(TextView)view.findViewById(R.id.goods_item_add_btn);
			view.setTag(holder);
		}
